...
//    private var tableView: UITableView!
    ...
    private func setupSearchController(){
        ...
        notificationCenter.addObserver(forName: UIResponder.keyboardDidShowNotification, object: nil, queue: .main) { self.handleKeyboard(notification: $0) }
        notificationCenter.addObserver(forName: UIResponder.keyboardWillHideNotification, object: nil, queue: .main) { self.handleKeyboard(notification: $0) }
    }
